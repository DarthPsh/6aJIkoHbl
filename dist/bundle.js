...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calc = __webpack_require__(/*! ./parts/calc */ "./parts/calc.js"),
      ...
      lightbox = __webpack_require__(/*! ./parts/lightbox */ "./parts/lightbox.js"),
...
function modal() {
  var btnEngineer = document.querySelector(".popup_engineer_btn"),
      ...
      modal = document.querySelector(".popup"); //Модальное окно вызова
  ...
  setTimeout(function () {
    modal.style.display = "block";
    document.body.parentElement.style.overflow = "hidden";
  }, 61000); // закрытие модальных окон при нажатии только на крестик
